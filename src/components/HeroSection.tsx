...
export function HeroSection() {
  ...
  return (
    <Box> {/* Wrap everything in a single root element */}
      {/* Banner Section (placed at the top as per client image style) */}
      <Container size="xl" py="xl">
        <Image src="img/Frame 2021.png" alt="Promo Naga Spesial" radius="md" width="100%" /> {/* Use Image component, full width */}
      </Container>
